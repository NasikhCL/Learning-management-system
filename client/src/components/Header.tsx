...
const Header = (props: Props) => {
  ...
  return (
    <div className=" h-16 w-full flex justify-between items-center border-b-2 sticky top-0">
        ...
        <svg class="w-5 h-5 md:hidden" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 17 14"><path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M1 1h15M1 7h15M1 13h15"></path></svg>
    </div>
  )
}
